...
//Code Here
 ...
 let lastIteamRemove = arr.pop()
 console.log(lastIteamRemove)
 console.log(arr)
...
switch(letterGrade){
  ...
  case 'F':
    ...
    break;  
  default:
   console.log("If the letter grade is not one of the above letters, console.log 'Not an eligible grade.")
   break;
